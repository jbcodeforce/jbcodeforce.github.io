...
The list of major assets/contributions I developed over the last 8 years, at IBM, AWS, Confluent.

## Event Driven Architecture

* [Reference architecture for event-driven architecture](http://jbcodeforce.github.io/eda-studies)
* [Kafka studies](https://github.com/jbcodeforce/kafka-studies)
...
* Virtual book [on Apache Flink and Confluent Flink](http://jbcodeforce.github.io/flink-studies)
* [Shift left utilities to manage a Flink project](https://jbcodeforce.github.io/shift_left_utils) and migrate from batch processing to Flink real-time processing.
